...
public class MainActivity extends AppCompatActivity {
    ...
    List<Periodico> misFilas = new ArrayList<Periodico>();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        RecyclerView miRecycler = findViewById(R.id.RecyclerViewPeriodicos);
    ...
    public void cargarPeriodicos(){
        misFilas.clear();
        Cursor c = dbInterface.obtenerPeriodico();
        if (c==null){
            ...
            if (c.moveToFirst()){
                do{
                    ...
                    misFilas.add(new Periodico(c.getLong(0),
                            c.getString(1),
                            c.getString(2)));
                }while(c.moveToNext());
            }
    ...
    public boolean onContextItemSelected(MenuItem item){
        switch(item.getItemId()){
            case R.id.menuBorrar:
                ...
                dbInterface.borrarPeriodico(misFilas.get(posicionLongClick).getId());
